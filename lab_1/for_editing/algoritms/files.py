"""
This module contains functionality for working with files and keys 
(reading and writing files and bytes, serialization and deserialization of keys)
"""
